  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.error("Failed to create user. Please check all fields.");
      }
    } catch (err) {
            ...
            <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm">
              ...
              <div className="mt-10 pt-6 border-t border-slate-50 flex gap-4">
                ...
                <Button
                  type="button"
                  onClick={() => router.back()}
                  className="px-6 py-3 bg-amber-50-100 text-slate-500 hover:bg-slate-200 rounded-xl font-bold transition-all"
                >
                  Cancel
                </Button>
              </div>
